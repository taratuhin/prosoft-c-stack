 ...
 */
int32_t  stack_valid_handler( const  hstack_t  hstack )
{
 ...
 */
uint32_t  stack_size( const  hstack_t  hstack )
{
	uint32_t  size = 0;
    node_t  * node = NULL;
 ...
 *   \return  Нет
 */
void  stack_push( const  hstack_t  hstack, const  void  * data_in, const  uint32_t  size )
{
	node_t  * node = NULL;
 ...
 */
uint32_t  stack_pop( const  hstack_t  hstack, void  * data_out, const  uint32_t  size )
{
